...
def main() -> None:
    ...
    report = evaluate_tabular_hgb_avm(gold)
    reports_path = Path("reports/generated/avm_tabular_hgb_metrics_20260726.json")
    evidence_path = Path("docs/evidence/avm_tabular_hgb_metrics_20260726.json")
