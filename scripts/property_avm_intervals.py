...
def main() -> None:
    ...
    report = evaluate_tabular_hgb_intervals(gold)
    reports_path = Path("reports/generated/avm_tabular_hgb_intervals_20260726.json")
    evidence_path = Path("docs/evidence/avm_tabular_hgb_intervals_20260726.json")
