...
- The 2026-07-26 read-only GCP smoke did not move data to GCS, BigQuery, Cloud SQL, or any other managed service.
- The 2026-07-26 Dockerized API load smoke read the existing VM-only gold parquet through a read-only Compose bind mount. It did not copy generated data into Git.
