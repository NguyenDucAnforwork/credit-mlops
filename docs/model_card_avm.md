...
- Warm API TestClient load: AVM p95 176.43 ms with 0% errors at concurrency 10
...
- Warm API evidence is in-process TestClient only; service and Cloud Run p95 are not measured.
