...
Deployment update: the immutable API image is registry-backed by digest, but no Cloud Run model serving claim is made because full Terraform apply and runtime smoke were not executed.
